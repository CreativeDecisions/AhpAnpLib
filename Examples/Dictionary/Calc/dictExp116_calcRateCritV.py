...
input.export4ExcelQuestFull(myModel,"Exp116_Excel_FullQuestionnaire_empty.xlsx",True,False)
#import the pairwise comparison for criteria priorities
calc.calcAHPMatricesSave2File(myModel,"Exp116_Excel_FullQuestionnaire_filledin.xlsx","Exp116_Excel_CriteriaPriorities.xlsx",True,False,True)
...
myModel.rateModel.addCriteriaByVar(XNode,YNode)
#create scales
...
#calculate priorities of ratings criteria
