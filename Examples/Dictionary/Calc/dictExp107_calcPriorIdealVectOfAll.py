...
input.export4ExcelQuestFull(expModel,"Exp107_Excel_empty.xlsx",True)
#Import Excel of all pairwise comparison matrices
input.importFromExcel(expModel,"Exp107_Excel_pwFilledin.xlsx","pairwise_comp")

ideaPriorities = calc.calcPriorIdealVectOfAll(expModel)
print(ideaPriorities)