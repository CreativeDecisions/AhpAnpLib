...
input.export4ExcelQuestFull(myModel,"Exp104_Excel_FullQuestionnaire_empty.xlsx",True,False)
#import the pairwise comparison for criteria priorities
calc.calcAHPMatricesSave2File(myModel,"Exp104_Excel_FullQuestionnaire_filledin.xlsx","Exp66_Excel_CriteriaPriorities.xlsx",True,False,True)
