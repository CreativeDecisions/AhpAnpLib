...
input.export4ExcelQuestFull(myModel,"Exp108_Excel_FullQuestionnaire_empty.xlsx",True,False)
#import the pairwise comparison for criteria priorities
calc.calcAHPMatricesSave2File(myModel,"Exp108_Excel_FullQuestionnaire_filledin.xlsx","Exp108_Excel_CriteriaPriorities.xlsx",True,False,True)
...
input.export4ExcelRatingsSetup(myModel,"Exp108_RatingsSetup_empty.xlsx",True)
#import ratings scales judgments
input.importRatingsFromExcel(myModel,"Exp108_RatingScales_filledin.xlsx","rating_scales",False)
scaleIdealPriorities = calc.calcPriorIdealVectOfAllScales(myModel)
print(scaleIdealPriorities)