...
input.export4ExcelQuestFull(expModel,"Exp97_Excel_empty.xlsx",False)
#Import Excel of all pairwise comparison matrices
input.importFromExcel(expModel,"Exp97_Excel_pwFilledin.xlsx","pairwise_comp")

unweighted = calc.calcUnweightedSuperMatrix(expModel)
weighted = calc.calcWeightedSupermatrix(expModel)
localPriorities = calc.calcPrioritiesNormalizedByCluster(weighted,expModel)
print("Priorities normalized by cluster: ",localPriorities)