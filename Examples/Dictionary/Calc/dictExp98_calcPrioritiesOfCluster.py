...
input.export4ExcelQuestFull(expModel,"Exp98_Excel_empty.xlsx",False)
#Import Excel of all pairwise comparison matrices
input.importFromExcel(expModel,"Exp98_Excel_pwFilledin.xlsx","pairwise_comp")

unweighted = calc.calcUnweightedSuperMatrix(expModel)
weighted = calc.calcWeightedSupermatrix(expModel)
localPriorities = calc.calcPrioritiesOfCluster(weighted,cluster1.name,expModel,True)
