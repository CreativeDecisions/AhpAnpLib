...
input.export4ExcelQuestFull(myModel,"Exp113_Excel_FullQuestionnaire_empty.xlsx",True,False)
#import the pairwise comparison for criteria priorities
calc.calcAHPMatricesSave2File(myModel,"Exp113_Excel_FullQuestionnaire_filledin.xlsx","Exp113_Excel_CriteriaPriorities.xlsx",True,False,True)
...
input.export4ExcelRatingsSetup(myModel,"Exp113_RatingsSetup_empty.xlsx",False)
#import ratings scales judgments
input.importRatingsFromExcel(myModel,"Exp113_RatingSetup_filledin.xlsx","rating_scales",False)
input.importRatTableFromExcel(myModel,"Exp113_RatingSetup_filledin.xlsx","rating_table",False) 

calc.updateRateTblResults2Excel(myModel,"Exp113_RatingsTableResults.xlsx","rating_table",True)