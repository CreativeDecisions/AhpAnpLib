...
input.export4ExcelQuestFull(expModel,"Exp118_Excel_empty.xlsx",False)

calc.calcMatrices(expModel,"Exp118_Excel_pwfilledin.xlsx",True,False)
# how would nodes priorities in cluster "A" change when "X" changes
calc.sensitivityCellSupermatrixShort(expModel,"A","X",True)