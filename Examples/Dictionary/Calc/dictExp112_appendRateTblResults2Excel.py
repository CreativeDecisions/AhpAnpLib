...
input.export4ExcelQuestFull(myModel,"Exp112_Excel_FullQuestionnaire_empty.xlsx",True,False)
#import the pairwise comparison for criteria priorities
calc.calcAHPMatricesSave2File(myModel,"Exp112_Excel_FullQuestionnaire_filledin.xlsx","Exp112_Excel_CriteriaPriorities.xlsx",True,False,True)
...
input.export4ExcelRatingsSetup(myModel,"Exp112_RatingsSetup_empty.xlsx",True)
#import ratings scales judgments
input.importRatingsFromExcel(myModel,"Exp112_RatingSetup_filledin.xlsx","rating_scales",False)
input.importRatTableFromExcel(myModel,"Exp112_RatingSetup_filledin.xlsx","rating_table",False) 

calc.appendRateTblResults2Excel(myModel,"Exp112_RatingsTableResults.xlsx","rating_scales_results",False,False,True)
