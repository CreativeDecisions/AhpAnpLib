...
rowPos = calc.pwcMatrixRow (expModel,g_node,lv1Node1)
print('g_node column, lv1Node1 row:',rowPos)
rowPos = calc.pwcMatrixRow (expModel,g_node,lv1Node2)
print('g_node column, lv1Node2 row:',rowPos)
rowPos = calc.pwcMatrixRow (expModel,g_node,lv1Node3)
print('g_node column, lv1Node3 row:',rowPos)
rowPos = calc.pwcMatrixRow (expModel,g_node,aNode1)
print('g_node column, aNode1 row:',rowPos)
rowPos = calc.pwcMatrixRow (expModel,lv1Node2,aNode1)
print('lvNode2 column, aNode1 row:',rowPos)
rowPos = calc.pwcMatrixRow (expModel,lv1Node2,aNode2)
print('lvNode2 column, aNode2 row:',rowPos)
rowPos = calc.pwcMatrixRow (expModel,lv1Node2,aNode3)
print('lvNode2 column, aNode3 row:',rowPos)
