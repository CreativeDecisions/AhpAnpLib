...
input.export4ExcelQuestFull(expModel,"Exp117_Excel_empty.xlsx",False)

calc.calcMatrices(expModel,"Exp117_Excel_pwfilledin.xlsx",True,False)
calc.sensitivityCellSupermatrix(expModel,"X",True)