...
input.export4ExcelQuestFull(myModel,"Exp111_Excel_FullQuestionnaire_empty.xlsx",True,False)
#import the pairwise comparison for criteria priorities
calc.calcAHPMatricesSave2File(myModel,"Exp111_Excel_FullQuestionnaire_filledin.xlsx","Exp111_Excel_CriteriaPriorities.xlsx",True,False,True)
...
input.export4ExcelRatingsSetup(myModel,"Exp111_RatingsSetup_empty.xlsx",True)
#import ratings scales judgments
input.importRatingsFromExcel(myModel,"Exp111_RatingScales_filledin.xlsx","rating_scales",False)

calc.appendScaleResults2Excel(myModel,"Exp111_RatingsScalesResults.xlsx","rating_scales_resutls",True,True,True)
