...
input.export4ExcelQuestFull(expModel,"Exp110_Excel_empty.xlsx",True)
#Import Excel of all pairwise comparison matrices
input.importFromExcel(expModel,"Exp110_Excel_pwFilledin.xlsx","pairwise_comp")
calc.appendResults2Excel(expModel,"Exp110_Excel_results.xlsx","pairwise_comp_results",normalbar=True,idealbar=True,verb=True)