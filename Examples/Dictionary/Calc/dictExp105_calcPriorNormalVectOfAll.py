...
input.export4ExcelQuestFull(expModel,"Exp105_Excel_empty.xlsx",True)
#Import Excel of all pairwise comparison matrices
input.importFromExcel(expModel,"Exp105_Excel_pwFilledin.xlsx","pairwise_comp")

priorities = calc.calcPriorNormalVectOfAll(expModel)
print(priorities)