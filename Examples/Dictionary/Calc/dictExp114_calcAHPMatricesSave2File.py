...
input.export4ExcelQuestFull(expModel,"Exp114_Excel_empty.xlsx",True)
#Import Excel of all pairwise comparison matrices
calc.calcAHPMatricesSave2File(expModel,"Exp114_Excel_pwFilledin.xlsx","Exp114_Excel_results.xlsx",True,True,True,True)