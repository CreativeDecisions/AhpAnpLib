...
print("scale1 before updating: ",scale1.val_mat)
newpw = reqLib.np.array([[1,2,4],
        [0.5,1,2],
        [0.25,0.5,1]])
myModel.rateModel.updateScaleMatrix("ExampleScale1", newpw)
print("scale1 after updating: ",scale1.val_mat)
