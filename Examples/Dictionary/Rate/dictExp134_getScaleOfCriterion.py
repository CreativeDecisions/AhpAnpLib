...
myModel.rateModel.assignScale2CriterionByName("X subCri","ExampleScale1",False)
myModel.rateModel.assignScale2CriterionByName("Y subCri","ExampleScale2",False)
myModel.rateModel.assignScale2CriterionByName("Z subCri","ExampleScale2",False)

yScale = myModel.rateModel.getScaleOfCriterion(YsubCri)
print(yScale)