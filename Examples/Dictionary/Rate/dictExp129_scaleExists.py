...
scaleIndex=myModel.rateModel.scaleExists("ExampleScale1")
scaleIndex2=myModel.rateModel.scaleExists("New Scale")
print("Index of ExampleScale1: ",scaleIndex)
print("Index of New Scale: ",scaleIndex2)