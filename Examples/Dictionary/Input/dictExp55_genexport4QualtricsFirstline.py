...
myModel.addCluster2Model(Cluster0,Cluster1,Cluster2)
# add connections
...
Questionnaire= input.genexport4QualtricsFirstLineQuest("Exp55_QualtricsFirstline.txt",myModel,"important")
Questionnaire= input.genexport4QualtricsFirstLineQuest("Exp55_QualtricsFirstline_noHowmuch.txt",myModel,"dominant",False)