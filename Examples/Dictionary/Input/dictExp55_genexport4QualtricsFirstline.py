...
Questionnaire= input.genexport4QualtricsFirstLineQuest("Exp55_QualtricsFistline.txt",myModel,"important")
Questionnaire= input.genexport4QualtricsFirstLineQuest("Exp55_QualtricsFistline_noHowmuch.txt",myModel,"dominant",False)