...
input.export4ExcelQuestFull(myModel,"Example66_Excel_FullQuestionnaire_empty.xlsx",True,False)
#import the pairewise comparison for cirteria priorities
calc.calcAHPMatricesSave2File(myModel,"Example66_Excel_FullQuestionnaire_filledin.xlsx","Example66_Excel_CriteriaPriorities.xlsx",True,False,True)
