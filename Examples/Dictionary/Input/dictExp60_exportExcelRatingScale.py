...
input.export4ExcelQuestFull(myModel,"Example60_Excel_FullQuestionnaire_empty.xlsx",True,True)
...
input.export4ExcelRatingScales(myModel,"Exp60_ModelScale_empty.xlsx",False,True,False)