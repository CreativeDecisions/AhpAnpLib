...
#add connections
myModel.addNodeConnectionFromAllNodesToAllNodesOfCluster("Two","One")
myModel.addNodeConnectionFromAllNodesToAllNodesOfCluster("Three","One")

myModel.remAllNodeConnectionsFrom("D")
myModel.showAllNodeConnections()