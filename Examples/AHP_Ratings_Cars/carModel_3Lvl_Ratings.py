...
scale1b=rate.RatScale("PriceScaleEmpty")
...
scale2_1=input.readRatScaleRPCfile("Price_ScaleRCP","./RateScales/2_1.rcp")
carModel.rateModel.addScaleByVar(scale2_1)
# print(scale2_1)

scale2_2=input.readRatScaleRPCfile("HighMediumLow_ScaleRCP","./RateScales/2_2.rcp")
carModel.rateModel.addScaleByVar(scale2_2)
# print(scale2_2)

scale1=input.readRatScaleRPCfile("Excellent2Poor_ScaleRCP","./RateScales/1.rcp")
carModel.rateModel.addScaleByVar(scale1)
# print(scale1)

scale3=input.readRatScaleRPCfile("GoodMediumPoor_ScaleRCP","./RateScales/3.rcp")
...
input.importFromExcel(carModel,inputFilePath,"pairwise_comp",False)
...
# calc.calcAHPMatricesSave2File(carModel,inputFilePath,outputFilePath2,True,False,True)
