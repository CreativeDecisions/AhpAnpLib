...
#add by the variable name holding the node if the nodes already created
# carModel.rateModel.addAlternativesByVar(alt1,alt2,alt3,alt4,alt5, alt6)
    
#or add by the alternative (node) name all at once, or a few at a time
#if the alternaitve name is new, a new alternative object will be created automatiacally behind the scene
...
#this is how we read scale from RCP file -- generated by Super Decisions (legacy software tool for AHP/ANPcd)
