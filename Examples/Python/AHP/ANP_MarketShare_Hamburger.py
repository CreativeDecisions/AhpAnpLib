...
input.genexport4QualtricsQuestFull("./Examples/IO Files/HamburgerModel_Qualtrics_Full.txt",hamburger,"important",True)

input.genexport4QualtricsFirstLineQuest("./Examples/IO Files/HamburgerModel_Qualtrics_FirstLine.txt",hamburger,"important",True)

input.genexport4QualtricsFirstLineAboveDiagQuest("./Examples/IO Files/HamburgerModel_Qualtrics_FirstAndAbove.txt",hamburger,"important",True)

# #Google

input.genexport4GoogleQuestFull("./Examples/IO Files/HamburgerModel_Google_Full.csv",hamburger,"important",False)

input.genexport4GoogleFirstLineQuest("./Examples/IO Files/HamburgerModel_Google_FirstLine.csv",hamburger,"important",False)

input.genexport4GoogleFirstLineAboveDiagQuest("./Examples/IO Files/HamburgerModel_Google_FirstAndAbove.csv",hamburger,"important",False)

# Excel
input.export4ExcelQuestFull(hamburger,"./Examples/IO Files/HamburgerModel_Excel_Full.xlsx",False)
#win
#input.export4ExcelQuestFull(hamburger,".\Examples\IO Files\HamburgerModel_Excel_Full.xlsx",False)

#inputFilePath="./Examples/IO Files/HamburgerModel_Excel_Filledin.xlsx"
# wind
#inputFilePath=".\Examples\IO Files\HumburgerModel_Excel_Filledin.xlsx"

#outputFilepath = "./Examples/IO Files/HumburgerModel_Excel_results.xlsx"
