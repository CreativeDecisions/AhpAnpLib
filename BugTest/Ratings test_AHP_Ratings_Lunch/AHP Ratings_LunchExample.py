...
lunchModel.rateModel.addAlternativesByName("1Panera","2Primanti","3Subway","4Test","5Test","6Test","7Test")
...
input.calcExcelRatings(lunchModel,"LunchModel_Ratings_Table_filledIn2.xlsx","lunchModel_Ratings_Results.xlsx",True)